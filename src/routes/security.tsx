  ...
  return (
    <LegalShell section="§ Trust — Security" title="Security" updated="July 13, 2026">
      <Sec id="overview" heading="1. Overview">
        <p>
          This page is maintained by the AcidTest team to describe controls currently enabled in the
          product. It is not an independent certification.
        </p>
      </Sec>
      <Sec id="access" heading="2. Access & authentication">
        <ul className="ml-5 list-disc space-y-2">
          ...
          <li>
            Sessions are stored in httpOnly-compatible browser storage and rotated on refresh.
          </li>
      ...
      <Sec id="data" heading="3. Data handling">
        <p>
          Data in transit is protected with TLS 1.2+. Managed database and object storage providers
          encrypt data at rest. We minimize the data we store to what's needed to run the product.
        </p>
      </Sec>
      <Sec id="infra" heading="4. Infrastructure">
        <p>
          The app runs on a globally distributed edge runtime. Server functions execute in isolated
          workers with least-privilege secrets injected per environment.
        </p>
      </Sec>
      <Sec id="report" heading="5. Report a vulnerability">
        <p>
          ...
          with steps to reproduce. We respond within 2 business days and coordinate disclosure with
