  ...
  return (
    <LegalShell section="§ Legal — Terms" title="Terms of Service" updated="July 13, 2026">
      <Sec id="acceptance" heading="1. Acceptance">
        <p>
          By creating an account or using AcidTest you agree to these terms. If you don't
          agree, don't use the service.
        </p>
      </Sec>
      <Sec id="account" heading="2. Your account">
        <p>
          You are responsible for the security of your credentials and everything that
          happens under your account. Notify us immediately of any unauthorized use.
        </p>
      </Sec>
      <Sec id="credits" heading="3. Credits & billing">
        <p>
          Credits are prepaid units consumed by test synthesis and Threat Detection scans.
          Purchased credits are non-refundable except where required by law and do not
          expire on paid plans.
        </p>
      </Sec>
      ...
      <Sec id="liability" heading="5. Warranty & liability">
        <p>
          AcidTest is provided "as is". To the maximum extent permitted by law, we
          disclaim implied warranties and limit aggregate liability to the amount you
